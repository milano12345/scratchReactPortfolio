...
const AboutMe = () => {
  const [dayProject] = useState([
    ...
    },
    {
      ...
      link:
        "https://github.com/leachcoding/Sprint-Challenge-Applied-Javascript",
    },
    {
      imgSrc:
    ...
    },
    {
      ...
      title: "Web DB III",
      link:
        "https://github.com/leachcoding/node-db3-project?organization=leachcoding&organization=leachcoding",
    },
    {
      imgSrc:
